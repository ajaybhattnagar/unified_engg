            ...
            return (
                <div className="">
                    ...
                    <div className="d-flex justify-content-end mr-3">
                        <button className="btn btn-outline-success btn-sm mr-2" disabled={(parcelDetails['Status'] < 10 || parcelDetails['Status'] == 11) ? false : true} onClick={() => openRedeemModal(10)}>Redeem</button>
                        <button className="btn btn-outline-secondary btn-sm mr-2" disabled={(parcelDetails['Status'] < 9 || parcelDetails['Status'] == 11) ? false : true} onClick={() => openRedeemModal(9)}>Partial Redemption</button>
