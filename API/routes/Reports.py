...
def redemption_report(current_user):
    ...
    header_details[["REDEMPTION CHECK AMOUNT", "TOTAL PAYOFF"]] = header_details[["REDEMPTION CHECK AMOUNT", "TOTAL PAYOFF"]].apply(pd.to_numeric)
    header_details['REDEMPTIVE_VARIANCE'] = header_details['TOTAL PAYOFF'] - header_details['REDEMPTION CHECK AMOUNT']
