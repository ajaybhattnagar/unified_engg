...
"GET_LABOR_TICKETS": """SELECT 
                        ...
                        WHERE HOURS_WORKED IS NOT NULL AND CONVERT(DATE, TRANSACTION_DATE) BETWEEN '{FROM_DATE}' AND '{TO_DATE}' {EMP_ID_QUERY_STRING} {APPROVED_QUERY_STRING} ORDER BY TRANSACTION_ID DESC""",
