...
"GET_PARCEL_FEES_BY_ID_PAYOFF_REPORT": """
                    SELECT ID, UNIQUE_ID, CATEGORY, DESCRIPTION, AMOUNT, INTEREST, INTEREST_ACC_INTERVAL, CONVERT(EFFECTIVE_DATE, DATE) 'EFFECTIVE_DATE',  IFNULL(CONVERT(EFFECTIVE_END_DATE, DATE), '{END_DATE}') 'EFFECTIVE_END_DATE', 
