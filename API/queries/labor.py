...
"GET_WORKORDER_OPERATION_DETAILS": """SELECT OP.SEQUENCE_NO AS [value], (OP.RESOURCE_ID + ' ' + LEFT(ISNULL((CONVERT(NVARCHAR(MAX),CONVERT(VARBINARY(8000), OPB.BITS ))),''),45)) AS [label]            
                                        FROM OPERATION OP
